...
export function Sidebar({ sidebarOpen, setSidebarOpen }: SidebarProps) {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-slate-600 duration-300 ease-linear dark:bg-neutral-800  lg:static lg:translate-x-0 ${
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <h1 className="font-medium flex text-bodydark2">
            ...
            <span className="pt-4 mx-2">Auto Mecânica Silva</span>
          </h1>
        </NavLink>
